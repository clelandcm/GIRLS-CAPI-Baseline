...
DF <- DF %>% filter(!(PUID %in% Excluded_IDs) & date <= "2017-10-12")
HTC <- HTC %>% filter(!(PTID %in% Excluded_IDs) & today <= "2017-10-12")
...
```{r, eval=FALSE}
file.rename(from = "C:/chuck/NYU/Kurth/High Yield Testing/R Code/CAPI-Summaries-11October2017.html", 
