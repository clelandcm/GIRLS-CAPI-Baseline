...
capi.files <- list.files("C:/Bsync/3. Server Backup Files/5. OCT 2017/1. 6OCT2017", pattern = "BASELINE_BEHAVIORAL_SURVEY___GIRLS____", full.names = TRUE)
selftest.files <- list.files("C:/Bsync/3. Server Backup Files/5. OCT 2017/1. 6OCT2017", pattern = "SELF_TESTING_SURVEY", full.names = TRUE)
negcohort.files <- list.files("C:/Bsync/3. Server Backup Files/5. OCT 2017/1. 6OCT2017", pattern = "HIV_Negative_Cohort", full.names = TRUE)
poscohort.files <- list.files("C:/Bsync/3. Server Backup Files/5. OCT 2017/1. 6OCT2017", pattern = "HIV_Positive_Cohort", full.names = TRUE)
genelg.files <- list.files("C:/Bsync/3. Server Backup Files/5. OCT 2017/1. 6OCT2017", pattern = "General_Eligibility_Criteria", full.names = TRUE)
htcreg.files <- list.files("C:/Bsync/3. Server Backup Files/5. OCT 2017/1. 6OCT2017", pattern = "Electronic_HTC_Register", full.names = TRUE)
repcap <- read_csv("C:/Bsync/3. Server Backup Files/5. OCT 2017/1. 6OCT2017/01___BASELINE_BEHAVIORAL_SURVEY___GIRLS__REPEAT_CLIENTS____20th_June_2017_results.csv")
...
for(i in 1:length(htcreg.list)){htcreg.list[[i]] <- read_csv(file = htcreg.files[i])}
...
DF <- DF %>% filter(!(PUID %in% c("06-0064-01-01","08-0112-01-01","06-0103-02-01","08-0030-01-01","10-0089-02-01","07-0186-02-01")))
HTC <- HTC %>% filter(!(PTID %in% c("06-0064-01-01","08-0112-01-01","06-0103-02-01","08-0030-01-01","10-0089-02-01","07-0186-02-01")))
REPEATs <- REPEATs %>% filter(!(PUID %in% c("06-0064-01-01","08-0112-01-01","06-0103-02-01","08-0030-01-01","10-0089-02-01","07-0186-02-01")))
...
# Nok email on 9/13/2017
#############################################################
#
#               TEMPORARILY EXCLUDED
#
#############################################################
DF <- DF %>% filter(!(PUID %in% c('08-0269-02-01','06-0314-02-01','09-0233-02-01','09-0234-02-01','17-0306-02-01','17-0307-02-01','09-0235-01-01')))
HTC <- HTC %>% filter(!(PTID %in% c('08-0269-02-01','06-0314-02-01','09-0233-02-01','09-0234-02-01','17-0306-02-01','17-0307-02-01','09-0235-01-01')))
