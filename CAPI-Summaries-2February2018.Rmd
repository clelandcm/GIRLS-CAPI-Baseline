...
DF <- DF %>% dplyr::filter(!(PUID %in% Excluded_IDs) & date <= "2018-02-02")
HTC <- HTC %>% filter(!(PTID %in% Excluded_IDs) & today <= "2018-02-02")
...
```{r, eval=FALSE}
file.rename(from = "C:/chuck/NYU/Kurth/High Yield Testing/R Code/CAPI-Summaries-2February2018.html", 
