...
options(width = 150)
knitr::opts_chunk$set(echo = FALSE, message=FALSE, warning=FALSE, comment=NA, fig.width = 6, fig.asp = 0.618, out.width = "80%", fig.align = "center", dpi=200)
```
...
Excluded_IDs <- c('08-0030-01-01', '06-0064-01-01', '08-0112-01-01', '06-0103-02-01', 
                  ...
                  '06-0396-02-01', '08-0469-01-01')

# Rao email on July 13, 2017 and Nok Chhun emails on August 21, 2017 and September 13, 2017
DF <- DF %>% filter(!(PUID %in% Excluded_IDs) & date <= "2017-11-15")
HTC <- HTC %>% filter(!(PTID %in% Excluded_IDs) & today <= "2017-11-15")
...
```{r, eval=FALSE}
file.rename(from = "C:/chuck/NYU/Kurth/High Yield Testing/R Code/CAPI-Summaries-6December2017.html", 
